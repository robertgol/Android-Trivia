...
class GameWonFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        // hide share menu button if the intent cannot be handled by the system
    ...
    private fun getShareIntent(): Intent {
        val arguments = GameWonFragmentArgs.fromBundle(arguments!!)
        return ShareCompat.IntentBuilder.from(activity)
                .setText(getString(
                        R.string.share_success_text,
                        arguments.numCorrect,
                        arguments.numQuestions
                ))
                .setType("text/plain")
                .intent
    }
